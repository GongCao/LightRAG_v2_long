...
from lightrag.llm import aoneai_complete_if_cache, whale_embedding
...
async def llm_model_func(
    ...
    return await aoneai_complete_if_cache(
        prompt,
        history_messages=history_messages,
        base_url="https://ducky.code.alibaba-inc.com",
        auth="Bearer bkVUbkFWendZa3JMV1Zxb3V2bnM=",
...
async def embedding_func(texts: list[str]) -> np.ndarray:
    return await whale_embedding(
        texts,
        model="goc_fault_report_copilot",
        api_key="NJXR9NAXOX",
        base_url="https://whale-wave.alibaba-inc.com",
    )
